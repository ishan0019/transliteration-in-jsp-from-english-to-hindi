...
<%
out.println(q);
for(int iz=q;iz<q+2;iz++)
			    {   out.println("<br> <a href="+url[iz]+" style=' color:#FF0000; font-size: 18px; text-decoration:none;'>"+series_no+") "+title[iz]+"<p style=\" color:#000080; font-size: 14px; \" >"+url[iz]+"</p></a>");
                    out.println("<font size='3' color='#C1C1B8'>"+uni[iz]+"</font><br><hr>");		 	               
