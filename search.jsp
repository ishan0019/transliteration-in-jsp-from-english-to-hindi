		...
		<td width="700px" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"  height="100%">
				<tr>
				   ...
				   <div class="basiccontent pad10">
				   
<%  String userdata =request.getParameter("t1"),str="" ,data4,data2,data3,fileName2 = "/new/sym.txt",fileName3 = "/new/vow.txt",fileName4 = "/new/unicodes1.txt",str2="",str3="",str4="" ;
    ...
    {	flagonce=0;
        ...
        {   	
            ...
            {   
				   ...
				   out.println("<br> <a href="+url[t_length]+" style=' color:#FF0000; font-size: 18px; text-decoration:none;'>"+series_no+") "+rs0.getString("title")+"<p style=\" color:#000080; font-size: 14px; \" >"+url[t_length]+"</p></a>");
                  out.println("<font size='3' color='#C1C1B8'>"+rs0.getString("uni").substring(0,rs0.getString("uni").length()>1000 ? 1000:rs0.getString("uni").length())+"</font><br><hr>");		 	               
...
//###########   to resolve ambiguity of a to " "      ###########
        ...
        while(i<datalength)
        {
            ...
            {   // link and result set
                ...
                {  
                    ...
                    l_resultset = 0;
                    output_count =  output_count >= 2 ? 2 :output_count;
                    ...
                    {   var="";
                        ...
                        {	
                            ...
                            {   count[t_length] = 0;
                              ...
                              if(( C[n][m] * 100)/output_ar[q].length() > 90)
                    ...
                    {   l_resultset++;
                        ...
                        {    PreparedStatement pst2=null;
                            ...
                            {   out.println("<br> <a href="+url[i]+" style=' color:#FF0000; font-size: 18px; text-decoration:none;'>"+series_no+") "+rs2.getString("title")+"<p style=' color:#000080; font-size: 14px; '>"+url[i]+"</p></a>");    
				               ...
				               // uni[i] = rs2.getString("uni").substring(0,rs2.getString("uni").length()>1000 ? 1000:rs2.getString("uni").length());
  ...
  /*
String display_url[] = new String[series_no+1],display_title[] = new String[series_no+1],display_uni[] = new String[series_no+1] ;
  int ix=0;
  for(int iz=0;iz<t_length;iz++)
    {   if(url[i]!=null && !url[i].equals(""))
        {    display_url[ix] = url[iz];
	         display_title[ix] = title[iz];
	         display_uni[ix] = uni[iz];
	      ix++;
		}
	}
  
for(int iz=0;iz<ix;iz++)
  out.println("<br>"+display_url[iz]);
  %>
...
<%
     ...
     for( int iz=q+1;iz<=q+10;iz++ )
			    {  				    
				    {  out.println("<br> <a href="+display_url[iz-1]+" style=' color:#FF0000; font-size: 18px; text-decoration:none;'>"+iz+") "+display_title[iz-1]+"<p style=\" color:#000080; font-size: 14px; \" >"+display_url[iz-1]+"</p></a>");
                       out.println("<font size='3' color='#C1C1B8'>"+display_uni[iz-1]+"</font><br><hr>");		 	               
                       iz++;
					}
...
xmlhttp.open("GET","search.jsp?t1=<%=userdata%> & q="+str,true);
xmlhttp.send();
}
//showHint(<%=0%>);
